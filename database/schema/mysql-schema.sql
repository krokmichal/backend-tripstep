...
CREATE TABLE `flights` (
  ...
  `departure_airport_first` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `arrival_airport_first` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `departure_date_first` datetime NOT NULL,
  `arrival_date_first` datetime NOT NULL,
  `departure_airport_second` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `arrival_airport_second` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `sky_scanner_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
